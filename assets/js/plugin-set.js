...
jQuery('.big-video').magnificPopup({
  type: 'iframe',
  iframe: {
    patterns: {
      dailymotion: {
...
jQuery('.big-youtube').magnificPopup({
    disableOn: 700,
    type: 'iframe',
    mainClass: 'mfp-with-zoom mfp-img-mobile',
    removalDelay: 0,
...
// vimeo video
jQuery('.vim-video').magnificPopup({
  type: 'iframe',
  iframe: {
...
var masonry = new Macy({
   ...
   //nothing happen
        ...
        var jQueryWcontainerpro = jQuery( '.w-gallery-container' );
        jQueryWcontainerpro.isotope( {
  ...
  jQueryWcontainerpro.imagesLoaded().progress( function() {
  jQueryWcontainerpro.isotope('layout');
  });
  // filter galery hide
  jQuery(".filtter-icon").on("click", function() {
  jQuery("#filter-porto").slideToggle(600);
  jQuery("#filter-hide").toggleClass('show');
  });
  // owlCarousel gallery
  ...
  // owl projects detail
  var projectsBig = jQuery("#projectsBig");
